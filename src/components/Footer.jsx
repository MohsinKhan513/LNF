                    ...
                    <div className="footer-grid">
                        ...
                        <div className="footer-section">
                            ...
                            <ul className="footer-links">
                                ...
                                <li><Link to="/reportedItems" onClick={scrollToTop}>Reported Items</Link></li>
                                <li><Link to="/report-lost" onClick={scrollToTop}>Report Lost Item</Link></li>
                                <li><Link to="/report-found" onClick={scrollToTop}>Report Found Item</Link></li>
                                <li><Link to="/my-items" onClick={scrollToTop}>My Items</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="footer-section">
                            ...
                            <div className="contact-info">
                                <div className="contact-item">
                                    ...
                                    <a href="mailto:i243135@isb.nu.edu.pk">i243135@isb.nu.edu.pk</a>
                                </div>
                                <div className="contact-item">
                                    <svg className="contact-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                        <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" />
                                    </svg>
                                    <a href="tel:03000920513">0300-0920513</a>
                                </div>
                                <div className="contact-item">
                                    <svg className="contact-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
